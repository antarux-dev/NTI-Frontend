...
const sectors = ['IT / Softvér', 'Fintech', 'Zdravotníctvo', 'Výroba', 'Obchod', 'Vzdelávanie', 'Iné'];
  ...
  <div class="max-w-2xl">
    ...
    <div class="card-nti p-6">
      ...
      <form class="space-y-5" novalidate @submit.prevent="onSubmit">
        <div>
          <label for="name" class="label-nti">Názov firmy <span class="text-nti-green">*</span></label>
          <input id="name" v-model="name" v-bind="nameAttrs" type="text" class="input-nti" :class="{ error: errors.name }" />
        ...
        <div>
          ...
          <select id="sector" v-model="sector" v-bind="sectorAttrs" class="input-nti" :class="{ error: errors.sector }">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <input id="contactPhone" v-model="contactPhone" v-bind="contactPhoneAttrs" type="tel" class="input-nti" placeholder="+421 900 000 000" />
          </div>
          <div>
            <label for="website" class="label-nti">Web</label>
            <input id="website" v-model="website" v-bind="websiteAttrs" type="url" class="input-nti" :class="{ error: errors.website }" placeholder="https://firma.sk" />
