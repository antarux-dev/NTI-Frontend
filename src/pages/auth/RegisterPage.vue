...
<template>
  <div>
    ...
    <div class="card-nti p-8 mb-4">
      <h1 class="font-display text-2xl font-bold text-nti-white mb-2">Registrácia</h1>
    ...
    <div class="space-y-3">
      ...
      >
        <div
          class="size-11 rounded-xl bg-nti-green-dim border border-nti-green/20 flex items-center justify-center shrink-0 mt-0.5"
        >
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-3 mb-1">
            <span
              class="font-display font-semibold text-nti-white group-hover:text-nti-green transition-colors"
            >
              {{ option.title }}
            </span>
            <span v-if="option.badge" class="badge-gray text-xs">
              {{ option.badge }}
            </span>
          </div>
        ...
        <ArrowRight
          class="size-4 text-nti-muted group-hover:text-nti-green transition-colors shrink-0 mt-1"
        />
      </RouterLink>
    </div>
  </div>
